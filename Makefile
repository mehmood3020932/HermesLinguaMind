...
.PHONY: help setup up down logs doctor test backend-test mobile-analyze format clean smoke compose-config web
...
web:
	@echo "Website is served by the Nginx container at the same origin as the API."
